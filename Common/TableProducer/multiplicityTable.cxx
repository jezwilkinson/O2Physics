...
struct MultiplicityTableTaskIndexed {
  ...
  Partition<soa::Join<aod::Tracks, aod::TracksExtra>> tracksWithTPC = (aod::track::tpcNClsFindable > (uint8_t)0); //((aod::track::detectorMap & static_cast<uint8_t>(o2::aod::track::TPC)) != (uint8_t)0);
